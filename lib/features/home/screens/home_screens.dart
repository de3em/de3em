...
import 'package:da3em/features/banner/widgets/footer_banner_slider_widget.dart';
...
import 'package:da3em/features/home/widgets/featured_product_widget.dart';
      ...
      body: SafeArea(child: RefreshIndicator(
        ...
        /*  SliverAppBar(
          ...
          SliverAppBar(
            ...
            automaticallyImplyLeading: false,
            backgroundColor: Theme.of(context).highlightColor,
            title: Image.asset(Provider.of<ThemeController>(context, listen: false).darkTheme?
            Images.logo_white : Images.logoWithNameImage, height: 35),
            actions: [
              IconButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NotificationScreen(), // Replace with your screen
                    ),
                  );
                  print('Add icon button  notification pressed');
                },
              ),
          ...
          SliverToBoxAdapter(
            ...
            /*  Consumer<ShopController>(
                  builder: (context, topSellerProvider, child) {
                    return (topSellerProvider.sellerModel != null && (topSellerProvider.sellerModel!.sellers!=null
