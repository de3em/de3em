...
class CheckoutController with ChangeNotifier {
  ...
  CheckoutController({required this.checkoutServiceInterface, required this.dioClient, required ProfileController this.profile});
  ...
  Future<void> placeOrder(
   ...
   // var kk2 =dioClient?.sharedPreferences.getString(AppConstants.userId)??'35';

    var kk=profile.userInfoModel?.id??'35';
    dioClient!.post(AppConstants.m_point_action + '?userId=${kk} &storeId=1&function=add_points&action=buy');
...
class CheckoutController with ChangeNotifier {
  ...
  Future<void> placeOrder({required Function callback,
    String? addressID,
    String? phone,
    String? state,
        String? couponCode, String? couponAmount,
        String? billingAddressId, String? orderNote, String? transactionId,
        String? paymentNote, int? id, String? name,bool isfOffline = false, bool wallet = false, required String phone, required String state}) async {
