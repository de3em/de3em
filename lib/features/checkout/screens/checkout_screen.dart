...
import 'package:flutter_sixvalley_ecommerce/features/product_details/domain/models/product_details_model.dart' as px;
    ...
    return Scaffold(
                          ...
                          onTap: () async {
                            ...
                            if ((orderProvider.billingAddressIndex == null && !widget.hasPhysical && !orderProvider.sameAsBilling) || (orderProvider.billingAddressIndex == null && _billingAddress && !orderProvider.sameAsBilling)) {
                              ...
                              if (orderProvider.paymentMethodIndex != -1) {
                                ...
                                orderProvider.placeOrder(callback: _callback, addressID: addressId, couponCode: couponCode, couponAmount: couponCodeAmount, billingAddressId: billingAddressId, orderNote: orderNote);
      ...
      body: Consumer<AuthController>(builder: (context, authProvider, _) {
        return Consumer<CheckoutController>(builder: (context, orderProvider, _) {
          return ListView(physics: const BouncingScrollPhysics(), padding: const EdgeInsets.all(0), children: [
            ShippingDetailsWidget(hasPhysical: widget.hasPhysical, billingAddress: _billingAddress),
            ...
            //       //     return ListTile(
            //       //       title: Text(
            //       //           widget.cartList.first.shippingCost.toString()),
            //       //       subtitle: Text(
            //       //           widget.cartList.first.shippingCost.toString()),
            //       //       onTap: () {
            //       //         // showDialog(context: context, builder: (context){
            //       //         //   // return ShippingOptionDialog(
            //       //         //   //   cart: widget.cartList.first,
            //       //         //   //   shippingMethodList: widget.shippingMethodList!,
            //       //         //   //   choices: widget.cartList.first.choices!,
            //       //         //   // );
            //       //         // });
            //       //       },
            //       //     );
            ...
            if (Provider.of<AuthController>(context, listen: false).isLoggedIn()) CouponApplyWidget(couponController: _controller, orderAmount: _order),

//                 ListTile(
//                     title: Text("Shipping Dialog"),
//                onTap: (){

//                 CartModelBody cartModelBody = CartModelBody(
//                 productId:  widget.cartList.first.productId,
//                 quantity: widget.cartList.first.quantity,
//                 variation: widget.cartList.first.variation,
//                 color:  widget.cartList.first.color,
//                 variant:  widget.cartList.first.variant,
...
//                   cart:  cartModelBody,
//                   shippingMethodList:  widget.cartList.first.,
//                   choices:  widget.
//                 );
...
//                 ),
            ...
            //       labelText: getTranslated('order_note', context),
            //       inputType: TextInputType.multiline,
            //       inputAction: TextInputAction.done,
            //       maxLines: 3,
            //       bellowTextField: "This field is optional",
