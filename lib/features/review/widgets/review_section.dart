...
import 'package:da3em/features/review/screens/review_screen.dart';
...
import 'package:da3em/features/review/widgets/review_widget.dart';
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Container(
              ...
              child: Row(
                  ...
                  children: [
                    RatingBar(
                      rating: details.productDetailsModel?.averageReview != null
                          ? double.parse(
                              details.productDetailsModel!.averageReview!)
                          : 0.0, // Default value if averageReview is null
                      size: 18,
                    ),
