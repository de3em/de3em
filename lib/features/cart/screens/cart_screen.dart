...
import 'package:da3em/features/cart/widgets/cart_page_shimmer_widget.dart';
import 'package:da3em/features/cart/widgets/cart_widget.dart';
import 'package:da3em/features/checkout/screens/checkout_screen.dart';
import 'package:da3em/features/shipping/widgets/shipping_method_bottom_sheet_widget.dart';
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    if (configProvider
                                      ...
                                      print(
                                          '=====TotalPhysical====cart===>>${totalPhysical}');
                                      print(
                                          '=====OnlyDigital=====cart====>>${onlyDigital}');
                                      print(
                                          '=====hasPhicial=====cart====>>${totalPhysical > 0}');
                                                                        ...
                                                                        children: [
                                                                          SizedBox(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              side: MaterialStateBorderSide.resolveWith((states) => BorderSide(width: 2, color: Theme.of(context).primaryColor.withOpacity(0.10))),
