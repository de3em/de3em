...
// import 'package:da3em/features/location/domain/models/place_details_model.dart';
...
//   dynamic? get mapController => _mapController;
...
//   void getCurrentLocation(BuildContext context, bool fromAddress, {dynamic? mapController}) async {
//     _loading = true;
//     notifyListeners();
//     // Position myPosition;
//     try {
...
//   void updateMapPosition(dynamic? position, bool fromAddress, String? address, BuildContext context) async {
...
//   void setLocation(String? placeID, String? address, dynamic? mapController) async {
//     _loading = true;
//     notifyListeners();
...
//     if(mapController != null) {
//       // mapController.animateCamera(dynamic.newCameraPosition(dynamic(target: LatLng(
...
//   void setMapController(dynamic mapController) {
//     // _mapController = mapController;
//   }

//   Future<String> getAddressFromGeocode(dynamic latLng, BuildContext context) async {
