...
import 'package:da3em/features/checkout/screens/checkout_screen.dart';
import 'package:da3em/features/product/domain/models/product_model.dart';
import 'package:da3em/features/product_details/widgets/color_selection_widget.dart';
import 'package:da3em/features/product_details/controllers/product_details_controller.dart';
import 'package:da3em/features/product_details/domain/models/product_details_model.dart' as prefix;
...
class CartBottomSheetWidgetState extends State<CartBottomSheetWidget> {
    ...
    return Material(
                                ...
                                if (widget.product!.images!.length == 1) ...[
                                    ...
                                    Container(
                                      ...
                                      child: CustomImageWidget(
                                        image: '${widget.product?.colorImage?.firstOrNull?.imageName}',
      ...
      //TODO i don't know how colors looks like in the app so i will just add a container with a border
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text(getTranslated('Qty', context)!, style: textMedium.copyWith(fontWeight: FontWeight.bold, fontSize: 12)),
                        const SizedBox(
                          width: Dimensions.paddingSizeSmall,
                        ),
                        Container(
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), border: Border.all(color: Theme.of(context).primaryColor.withOpacity(.2))),
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(details.quantity.toString(), style: textMedium.copyWith(fontSize: 12, fontWeight: FontWeight.bold)),
                              ),
                        ...
                        Text(
                          ...
                          style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: Theme.of(context).hintColor, fontSize: 12),
                        ),
                        Spacer(),
                      ],
                    ),
  ...
  void _navigateToCheckoutScreen(BuildContext context, CartModel cart, double shippingCost, List<ShippingMethodModel>? shippingList) {
