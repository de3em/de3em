...
import 'package:da3em/features/address/domain/repositories/address_repository_interface.dart';
import 'package:da3em/features/address/domain/services/address_service.dart';
import 'package:da3em/features/address/domain/services/address_service_interface.dart';
...
import 'package:da3em/features/auth/domain/repositories/auth_repository.dart';
import 'package:da3em/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:da3em/features/auth/domain/services/auth_service.dart';
import 'package:da3em/features/auth/domain/services/auth_service_interface.dart';
import 'package:da3em/features/banner/controllers/banner_controller.dart';
import 'package:da3em/features/banner/domain/repositories/banner_repository.dart';
import 'package:da3em/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:da3em/features/banner/domain/services/banner_service.dart';
...
import 'package:da3em/features/brand/domain/services/brand_service.dart';
import 'package:da3em/features/brand/domain/services/brand_service_interface.dart';
import 'package:da3em/features/cart/domain/repositories/cart_repository.dart';
import 'package:da3em/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:da3em/features/cart/domain/services/cart_service.dart';
import 'package:da3em/features/cart/domain/services/cart_service_interface.dart';
import 'package:da3em/features/category/domain/repositories/category_repo.dart';
import 'package:da3em/features/category/domain/repositories/category_repo_interface.dart';
import 'package:da3em/features/category/domain/services/category_service.dart';
import 'package:da3em/features/category/domain/services/category_service_interface.dart';
import 'package:da3em/features/chat/domain/repositories/chat_repository.dart';
import 'package:da3em/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:da3em/features/chat/domain/services/chat_service.dart';
...
import 'package:da3em/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:da3em/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:da3em/features/checkout/domain/services/checkout_service.dart';
...
import 'package:da3em/features/compare/domain/repositories/compare_repository.dart';
import 'package:da3em/features/compare/domain/repositories/compare_repository_interface.dart';
import 'package:da3em/features/compare/domain/services/compare_service.dart';
...
import 'package:da3em/features/contact_us/domain/repository/contact_us_repository.dart';
import 'package:da3em/features/contact_us/domain/repository/contact_us_repository_interface.dart';
import 'package:da3em/features/contact_us/domain/services/contact_us_service.dart';
import 'package:da3em/features/contact_us/domain/services/contact_us_service_interface.dart';
import 'package:da3em/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:da3em/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:da3em/features/coupon/domain/services/coupon_service.dart';
import 'package:da3em/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:da3em/features/address/domain/repositories/address_repository.dart';
...
import 'package:da3em/features/deal/domain/repositories/featured_deal_repository.dart';
import 'package:da3em/features/deal/domain/repositories/featured_deal_repository_interface.dart';
import 'package:da3em/features/deal/domain/repositories/flash_deal_repository.dart';
import 'package:da3em/features/deal/domain/repositories/flash_deal_repository_interface.dart';
import 'package:da3em/features/deal/domain/services/featured_deal_service.dart';
import 'package:da3em/features/deal/domain/services/featured_deal_service_interface.dart';
import 'package:da3em/features/deal/domain/services/flash_deal_service.dart';
import 'package:da3em/features/deal/domain/services/flash_deal_service_interface.dart';
import 'package:da3em/features/location/controllers/location_controller.dart';
import 'package:da3em/features/location/domain/repositories/location_repository.dart';
import 'package:da3em/features/location/domain/repositories/location_repository_interface.dart';
import 'package:da3em/features/location/domain/services/location_service.dart';
...
import 'package:da3em/features/loyaltyPoint/domain/repositories/loyalty_point_repository_interface.dart';
import 'package:da3em/features/loyaltyPoint/domain/services/loyalty_poin_service.dart';
...
import 'package:da3em/features/notification/domain/repositories/notification_repository.dart';
import 'package:da3em/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:da3em/features/notification/domain/services/notification_service.dart';
...
import 'package:da3em/features/onboarding/domain/repositories/onboarding_repository.dart';
import 'package:da3em/features/onboarding/domain/repositories/onboarding_repository_interface.dart';
import 'package:da3em/features/onboarding/domain/services/onboarding_service.dart';
...
import 'package:da3em/features/order/domain/repositories/order_repository.dart';
import 'package:da3em/features/order/domain/repositories/order_repository_interface.dart';
import 'package:da3em/features/order/domain/services/order_service.dart';
import 'package:da3em/features/order/domain/services/order_service_interface.dart';
import 'package:da3em/features/order_details/controllers/order_details_controller.dart';
import 'package:da3em/features/order_details/domain/repositories/order_details_repository.dart';
import 'package:da3em/features/order_details/domain/repositories/order_details_repository_interface.dart';
import 'package:da3em/features/order_details/domain/services/order_details_service.dart';
...
import 'package:da3em/features/product/domain/repositories/product_repository.dart';
import 'package:da3em/features/product/domain/repositories/product_repository_interface.dart';
import 'package:da3em/features/product/domain/repositories/seller_product_repository.dart';
import 'package:da3em/features/product/domain/repositories/seller_product_repository_interface.dart';
import 'package:da3em/features/product/domain/services/product_service.dart';
import 'package:da3em/features/product/domain/services/product_service_interface.dart';
import 'package:da3em/features/product/domain/services/seller_product_service.dart';
...
import 'package:da3em/features/product_details/domain/repositories/product_details_repository.dart';
import 'package:da3em/features/product_details/domain/repositories/product_details_repository_interface.dart';
import 'package:da3em/features/product_details/domain/services/product_details_service.dart';
...
import 'package:da3em/features/profile/domain/repositories/profile_repository.dart';
import 'package:da3em/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:da3em/features/profile/domain/services/profile_service.dart';
...
import 'package:da3em/features/refund/domain/repositories/refund_repository.dart';
import 'package:da3em/features/refund/domain/repositories/refund_repository_interface.dart';
import 'package:da3em/features/refund/domain/services/refund_service.dart';
import 'package:da3em/features/refund/domain/services/refund_service_interface.dart';
import 'package:da3em/features/reorder/controllers/re_order_controller.dart';
import 'package:da3em/features/reorder/domain/repositories/re_order_repository.dart';
import 'package:da3em/features/reorder/domain/repositories/re_order_repository_interface.dart';
import 'package:da3em/features/reorder/domain/services/re_order_service.dart';
...
import 'package:da3em/features/review/domain/repositories/review_repository.dart';
import 'package:da3em/features/review/domain/repositories/review_repository_interface.dart';
import 'package:da3em/features/review/domain/services/review_service.dart';
import 'package:da3em/features/review/domain/services/review_service_interface.dart';
import 'package:da3em/features/search_product/domain/repositories/search_product_repository_interface.dart';
import 'package:da3em/features/search_product/domain/services/search_product_service.dart';
...
import 'package:da3em/features/shipping/domain/repositories/shipping_repository.dart';
import 'package:da3em/features/shipping/domain/repositories/shipping_repository_interface.dart';
import 'package:da3em/features/shipping/domain/services/shipping_service.dart';
import 'package:da3em/features/shipping/domain/services/shipping_service_interface.dart';
import 'package:da3em/features/shop/domain/repositories/shop_repository.dart';
import 'package:da3em/features/shop/domain/repositories/shop_repository_interface.dart';
import 'package:da3em/features/shop/domain/services/shop_service.dart';
import 'package:da3em/features/shop/domain/services/shop_service_interface.dart';
import 'package:da3em/features/splash/controllers/splash_controller.dart';
import 'package:da3em/features/splash/domain/repositories/splash_repository.dart';
import 'package:da3em/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:da3em/features/splash/domain/services/splash_service.dart';
import 'package:da3em/features/splash/domain/services/splash_service_interface.dart';
import 'package:da3em/features/support/controllers/support_ticket_controller.dart';
import 'package:da3em/features/support/domain/repositories/support_ticket_repository.dart';
import 'package:da3em/features/support/domain/repositories/support_ticket_repository_interface.dart';
import 'package:da3em/features/support/domain/services/support_ticket_service.dart';
import 'package:da3em/features/support/domain/services/support_ticket_service_interface.dart';
import 'package:da3em/features/wallet/controllers/wallet_controller.dart';
import 'package:da3em/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:da3em/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:da3em/features/wallet/domain/services/wallet_service.dart';
...
import 'package:da3em/features/wishlist/domain/repositories/wishlist_repository.dart';
import 'package:da3em/features/wishlist/domain/repositories/wishlist_repository_interface.dart';
import 'package:da3em/features/wishlist/domain/services/wishlist_service.dart';
import 'package:da3em/features/wishlist/domain/services/wishlist_service_interface.dart';
...
Future<void> init() async {
  ...
  sl.registerFactory(() => ShopController(shopServiceInterface: sl(),dioClient: sl(),
      profile :sl()));
